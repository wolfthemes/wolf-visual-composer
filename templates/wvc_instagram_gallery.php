...
if ( ! function_exists( 'sb_instagram_feed_init' ) ) {
	printf(
		wvc_kses( __( '<p>Please install <a href="%1$s" target="_blank">%2$s</a> plugin to display this element.</p>', 'wolf-visual-composer' ) ),
...
} elseif ( ! wvc_is_new_animation( $css_animation ) ) {
