...
if ( wvc_get_revslider_id_by_alias( $alias ) ) {
	...
	$output .= sprintf(
		__( 'This slider is missing. If you have imported one of our theme demo content, you can import the slider by following the instruction <a href="%s" target="_blank"><strong>HERE</strong>.</a>', 'wolf-visual-composer' ),
