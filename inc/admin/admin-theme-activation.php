...
add_action( 'wolf_core_about_me_tab', 'wvc_output_about_me_tab' );
...
add_action( 'wolf_core_about_me_tab_content', 'wvc_output_about_me_tab_content' );
...
// add_action( 'wolf_core_license_tab', 'wvc_output_license_tab' );
...
// add_action( 'wolf_core_license_tab_content', 'wvc_output_license_tab_content' );
